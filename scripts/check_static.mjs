...
const requiredFiles = [
  'index.html', 'app.css', 'app-core.js', 'motion-model.js', 'gif-retimer.js', 'app.js', 'app-image.js', 'app-export.js', 'app-events.js', 'gif-encoder.js', 'gif-worker.js',
  'sw.js', 'manifest.webmanifest', 'icon.svg', 'robots.txt', 'ai.txt', 'sitemap.xml', 'README.md', 'SECURITY.md', 'MAINTENANCE.md',
  'scripts/test_app_core.mjs', 'scripts/test_motion_model.mjs', 'scripts/test_gif_encoder.mjs', 'scripts/test_gif_retimer.mjs', 'scripts/test_gif_disposal.mjs', 'scripts/test_gif_dominant_color.mjs',
];
...
const app = [motionModel, gifRetimer, appMain, appImage, appExport, appEvents].join('\n');
...
assert.match(index, /application-version" content="9"/);
assert.match(index, /Build 9/);
...
assert.match(index, /app-image\.js\?v=4/);
assert.match(index, /app-export\.js\?v=8/);
assert.match(index, /app-events\.js\?v=8/);
assert.match(appExport, /gif-worker\.js\?v=5/);
assert.match(appEvents, /sw\.js\?v=9/);
assert.match(appEvents, /updateViaCache: 'none'/);
assert.match(worker, /gif-encoder\.js\?v=5/);
assert.match(sw, /image-motion-tool-v9/);
...
for (const asset of ['app.css?v=3', 'app-core.js?v=4', 'motion-model.js?v=7', 'gif-retimer.js?v=1', 'app.js?v=8', 'app-image.js?v=4', 'app-export.js?v=8', 'app-events.js?v=8', 'gif-encoder.js?v=5', 'gif-worker.js?v=5']) {
