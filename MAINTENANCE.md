...
- Blobの一時URLは出力種類ごとに1つだけ保持し、新しいURLを作る前とpagehide時にURL.revokeObjectURLで破棄する
...
4. 9種類の動きを再生する
5. 「伸縮」を選び、足元寄りを支点に横へ広がり、縦へ縮みながら少し沈んで元へ戻ることを確認する
6. 「動きの速さ」を遅く、標準、速くへ変え、プレビューの速さとGIF見積りの再生時間が同じ方向に変わることを確認する
7. 「アニメーション内の動作回数」が通常設定にあり、1回から4回を選べることを確認する
8. 標準速度でGIFを保存し、保存後に別タブ用リンクと「速度を変えて再生成」が表示されることを確認する
9. 動きの速さだけを変えて「速度を変えて再生成」を押し、最後に生成した動き、画像位置、サイズ、色品質を保ったまま速度だけが変わることを確認する
...
15. 呼吸するが足元を保ち、縦横へ穏やかに伸縮することを確認する
16. ゆっくり拡大して戻るが等倍から始まり、拡大後に等倍へ戻ることを確認する
